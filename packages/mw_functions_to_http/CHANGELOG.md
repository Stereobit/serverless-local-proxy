...
* **Redux:** Support redux and redux remote dev tools ([10b60d3](https://github.com/serverless-local-proxy/commit/10b60d3))
...
**Note:** Version bump only for package @serverless-local-proxy/mw_functions_to_http
